-- Alterar a coluna codigo_cca para permitir nulo ou ter um valor padrão
ALTER TABLE public.profiles ALTER COLUMN codigo_cca SET DEFAULT 'AGENCIA';

-- Recriar a função handle_new_user para tratar usuários agencia corretamente
